...
import { Sparkles, Loader2, Trash2, AlignLeft, FolderTree, GitMerge } from 'lucide-react'
...
export function CommitComposer({ repo }: { repo: RepoData }): React.JSX.Element {
  ...
  return (
    <div className="composer">
      ...
      <div className="composer-lists">
        {conflicted.length > 0 && (
          <div className="stage-section conflict-section">
